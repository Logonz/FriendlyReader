...
if (typeof responsiveVoice != "undefined") {
  ...
  var ResponsiveVoice = function() {
    ...
    self.speak = function(text, voicename, parameters) {
      ...
      if (text == undefined) {
        alert(
          "Tyvärr fungerar inte denna funktion i din webbläsare. Prova istället webbläsarna Chrome, Safari eller IOS."
        );
      }
        ...
        if (!fallbackMode) {
          ...
          var url =
            "http://responsivevoice.org/responsivevoice/getvoice.php?t=" +
              multipartText[i] +
              "&tl=" +
              profile.collectionvoice.lang ||
            profile.systemvoice.lang ||
            "en-US";
    ...
    self.Dispatch = function(name) {
      if (
        self.hasOwnProperty(name + "_callbacks") &&
